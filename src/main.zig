                ...
                switch (it.zig_equivalent) {
                    ...
                    .lto => {
                        if (mem.eql(u8, it.only_arg, "flto")) {
                            ...
                            create_module.opts.lto = .thin;
                        } else if (mem.eql(u8, it.only_arg, "jobserver")) {
                            create_module.opts.lto = .jobserver;
                        } else {
